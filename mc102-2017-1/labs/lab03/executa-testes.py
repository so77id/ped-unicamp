...
# a./rquivos arqs-03/arq<i>.out e./ arqs-03/arq<i>.diff.

import os
import sys

i = 1
testfile = "./arqs-03/arq" + str(i) + ".in"

while (os.path.exists(testfile)):
    resfile = "./arqs-03/arq" + str(i) + ".res"
    if not os.path.exists(resfile):
        print("Arquivo ", resfile, "inexistente.")
        sys.exit()

    outfile = "./arqs-03/arq" + str(i) + ".out"
    ...
    difffile = "./arqs-03/arq" + str(i) + ".diff"
